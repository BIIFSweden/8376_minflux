...
# -----------------------------
# Build 3D Plotly figure with both channels merged
# -----------------------------
fig = go.Figure()
...
# -----------------------------
fig.update_layout(
    title="MINFLUX localizations 3D (2 channels merged)",
...
# -----------------------------
webview.create_window("MINFLUX 3D viewer (2 channels)", html=html, width=1000, height=900)
webview.start()